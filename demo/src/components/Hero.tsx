...
const code = `import { checkConnectivity, watchConnectivity } from 'netlytics';
...
export function Hero() {
  return (
    <div className="overflow-hidden bg-[#F3F3F3] dark:bg-slate-900 dark:-mt-19 dark:-mb-32 dark:pt-19 dark:pb-32">
        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-8 gap-y-16 px-4 lg:max-w-8xl lg:grid-cols-2 lg:px-8 xl:gap-x-16 xl:px-12">
          <div className="relative z-10 md:text-center lg:text-left">
            ...
            <div className="relative">
              <p className="inline bg-linear-to-r from-indigo-400 dark:from-indigo-200 via-sky-400 to-indigo-300 dark:to-indigo-200 bg-clip-text font-display text-5xl tracking-tight text-transparent">
                Reliable internet connectivity detection.
              </p>
              <p className="mt-3 text-2xl tracking-tight text-slate-400">
                Detect connectivity, measure latency, and identify connection types
                for web apps — without draining the battery.
              </p>
              <div className="mt-8 flex gap-4 md:justify-center lg:justify-start">
                <Button href="/docs/quick-start">Get started</Button>
                <Button href="https://github.com/en-atul/netlytics" variant="secondary">
                  View on GitHub
                </Button>
              </div>
            </div>
