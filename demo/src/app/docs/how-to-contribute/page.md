...
nextjs:
  metadata:
    title: How to contribute
    description: Learn how to contribute to Netlytics and help improve the project.
---

Thank you for your interest in contributing to Netlytics! We welcome contributions from the community. {% .lead %}
...
Feel free to open an [issue](https://github.com/en-atul/netlytics/issues) for questions or discussions about contributions.
